...
int main(void) {
    ...
    //Toda esta parte es igual a la funcion crearCurso() solo que aca no se pone el primer cin.ignore() ya que sino se "comeria" el primer caracter insertado para el nombre
    string nombreCurso;
    cout << "Ingrese el nombre del curso: " << endl;
    getline(cin,nombreCurso); //Para que el curso pueda tener espacios en el nombre
    Curso cursoNuevo = Curso(nombreCurso);
    cout << "El curso: " << nombreCurso << " ha sido creado exitosamente." << endl;
    cursos.push_back(cursoNuevo);
        ...
        switch (opcion) {
            ...
            case 4: {
                ...
                if (cursoIndex < 1 || cursoIndex > cursos.size()) {
                    ...
                    // Crea el nuevo curso copiando los estudiantes del curso elegido
